        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    prixU = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    validee = table.Column<bool>(type: "bit", nullable: false),
                    tableID = table.Column<int>(type: "int", nullable: false),
                    servie = table.Column<bool>(type: "bit", nullable: false),
                    datecomm = table.Column<DateTime>(type: "datetime2", nullable: false),
                    serveurId = table.Column<int>(type: "int", nullable: false),
                    commencer = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commandes_Serveur_serveurId",
